...
En diciembre de 2013, SRK construyó un modelo numérico tridimensional con el que estimó flujos y efectuó predicciones para el dimensionamiento, cálculo y diseño conceptual de estructuras de cierre. Durante el diseño conceptual se actualizó el análisis para evaluar los efectos de la obturación del túnel sobre el macizo rocoso.[^1]

[^1]: Nuevamente se modeló la cuenca pero en esta oportunidad se representó el túnel obturado el cual funciona como un conducto a presión, captando agua del macizo en la parte alta de la cuenca y alimentando el macizo en la zona cercana al Tapón.

Con relación a los caudales esperables en el portal, el modelo hidrogeológico predijo flujos de infiltración preferencial aguas abajo del tapón, comprendidos entre 20 y 30 l/s como valor máximo. Este valor se ve reflejado en el Informe Cierre de Valvulas Tunel Marcelo [@beasa] 
